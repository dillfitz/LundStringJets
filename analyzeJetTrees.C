...
void analyzeJetTrees()
{

    TFile *infile = TFile::Open("pythiaJets.root");
    TFile *outfile = new TFile("jetHistos.root","RECREATE");
	// z histos //
	TH1F *zH = new TH1F("z", ";z;", 100, 0., 1.);
	TH1F *zH_kpOrkm = new TH1F("z_kpOrkm", ";z;", 100, 0., 1.);
	TH1F *zH_kpkmJets = new TH1F("z_kpkmJets", ";z;", 100, 0., 1.);

	// jT histos //
	TH1F *jtH = new TH1F("jt", ";jt;", 120, 0., 60.);
	TH1F *jtH_kpOrkm = new TH1F("jt_kpOrkm", ";jt;", 120, 0., 60.);
	TH1F *jtH_kpkmJets = new TH1F("jt_kpkmJets", ";jt;", 120, 0., 60.);

	// r histos //
	TH1F *rH = new TH1F("r", ";r;", 100, 0., 1.);
	TH1F *rH_kpOrkm = new TH1F("r_kpOrkm", ";r;", 100, 0., 1.);
	TH1F *rH_kpkmJets = new TH1F("r_kpkmJets", ";r;", 100, 0., 1.);
